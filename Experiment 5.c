...
int main(){
	 //Defining Variable 
    int i,l[10],b[10],size[10],op,costpl[10],costph[10],costpf[10],disc[10],L=6000,F=5000,H=9000,n;
    int age[10],phnum[10],id[10],search,low,high,mid;
    float discount[10];
	char prop[10],name[10];
